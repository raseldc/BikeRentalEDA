    ...
    public void when(Event event) {
        switch (event.getEventType()) {
            ...
            case BikeRentEvent.Bike_Rent_PaymentComplete ->
                    handle(SerializerUtils.deserializeFromJsonBytes(event.getData(), BikeRentEvent.class));
            case BikeRentEvent.Bike_Rent_PaymentCompleteFeedToSaga -> handle(SerializerUtils.deserializeFromJsonBytes(event.getData(), BikeRentEvent.class));
...
public  void rentBike(String bikeId, String bikeType, String location,String startDate,String endDate) {
    ...
    public  void rentBikeStatusChange1(String bikeId, String bikeType, String location,String startDate,String endDate) {
        final var data = BikeRentEvent.builder()
                .aggregateId(id)
                .bikeId(bikeId)
                .bikeType(bikeType)
        ...
        final byte[] dataBytes = SerializerUtils.serializeToJsonBytes(data);
        final var event = this.createEvent(BikeRentEvent.Bike_Rent_SagaUpdateStatus1, dataBytes, null);
        this.apply(event);
    }

    public  void rentBikePaymentInitiate(String bikeId, String bikeType, String location,String startDate,String endDate) {
        final var data = BikeRentEvent.builder()
                .aggregateId(id)
                .bikeId(bikeId)
                .bikeType(bikeType)
        ...
        final byte[] dataBytes = SerializerUtils.serializeToJsonBytes(data);
        final var event = this.createEvent(BikeRentEvent.Bike_Rent_SagaPaymentInitiate, dataBytes, null);
        this.apply(event);
    }
    @Override
    ...
    public void rentComplete(String bikeId, String bikeType, String location, String startDate, String endDate) {
        final var data = BikeRentEvent.builder()
                .aggregateId(id)
                .bikeId(bikeId)
                .bikeType(bikeType)
        ...
        final byte[] dataBytes = SerializerUtils.serializeToJsonBytes(data);
        final var event = this.createEvent(BikeRentEvent.Bike_Rent_PaymentComplete, dataBytes, null);
        this.apply(event);
    }
}